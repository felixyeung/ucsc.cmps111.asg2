...
#define SEMINIT		103	/* to PM: initialize a new semaphore */
#define GETPROCNR	104	/* to PM */
#define SEMVALUE	105	/* to PM: get the value of existing semaphore */

#define ISSETUGID	106	/* to PM: ask if process is tainted */
#define GETEPINFO_O	107	/* to PM: get pid/uid/gid of an endpoint */
#define SEMUP		108	/* to PM: increment existing semaphore */
#define SEMDOWN		109	/* to PM: decrement existing semaphore */
#define SEMFREE		110	/* to PM: release existing semaphore */
